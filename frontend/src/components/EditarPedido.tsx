...
// Las mismas que reconoce la contabilidad. Sin "Fiado": la diferencia de una
// edición no se puede fiar, porque abriría una cuenta por cobrar dentro de una
// venta que ya figura cobrada.
const METODOS_PAGO = [
  'Efectivo Bs',
  'Efectivo $',
  'Pago movil',
...
const METODOS_CON_REFERENCIA = new Set(METODOS_PAGO.filter((m) => !m.startsWith('Efectivo')))
